...
Passbook.configure do |passbook|
  ...
  passbook.wwdc_cert = File.dirname(File.expand_path(__FILE__ + '../../../')) + "/lib/certificates/wwdr.pem" 
  # Path to p12 key
  # passbook.p12_key = File.dirname(File.expand_path(__FILE__ + '../../../')) + "/lib/certificates/key.pem"
  # Path to your cert.p12 file
  passbook.p12_certificate = File.dirname(File.expand_path(__FILE__ + '../../../')) + "/lib/certificates/cert.p12"  
